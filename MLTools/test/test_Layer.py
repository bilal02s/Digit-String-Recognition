...
class LayerTest(unittest.TestCase):
    ...
    def testBackpropagation(self):
        ...
        self.layer.activation_prime = identity
        ...
        expected_bias = init_bias - 0.1
        expected_weights = init_weights - np.tile(input.T, 5).reshape(10, 5)*0.1
        expected_in_err = np.sum(init_weights, axis=1)
